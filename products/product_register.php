...
tr:hover {
    ...
    <body>
        ...
        <script>
            ...
            // Lógica de edição e exclusão de produtos
            document.querySelectorAll('.editButton').forEach(function(button) {
                button.addEventListener('click', function() {
                    var productId = this.getAttribute('data-id');
                    // Preencher o formulário de edição com os dados do produto (idealmente, você deve fazer isso via AJAX)
            ...
            document.querySelectorAll('.deleteButton').forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    if (confirm('Tem certeza que deseja excluir este produto?')) {
                        window.location.href = 'product_register.php?action=delete&id=' + productId;
                    }
                });
            });

            // Lógica de edição e exclusão de categorias
            document.querySelectorAll('.editCategoryButton').forEach(function(button) {
                button.addEventListener('click', function() {
                    var categoryId = this.getAttribute('data-id');
                    // Preencher o formulário de edição com os dados da categoria (idealmente, você deve fazer isso via AJAX)
...
document.addEventListener('DOMContentLoaded', function() {
    // Função para excluir um produto via AJAX
    ...
    // Vincular evento de clique para botões de exclusão
